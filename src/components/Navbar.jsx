  ...
  return (
    <nav className="flex items-center justify-between px-8 py-4 border-b border-gray-100">
      ...
      <div className="flex items-center gap-6">
        ...
        <a href="#" className="text-sm text-gray-500 hover:text-gray-800">Login</a>
        <button className="bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium px-5 py-2 rounded-lg">
          Get started free
        </button>
      </div>
    </nav>
